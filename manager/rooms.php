...
// } else {echo "Not working";};
    ...
    <form action="" method="post">
       <!-- <input type="text" name="id" value="<--?php echo $id; ?>"> -->
        <input type="text" name="firn" placeholder="Numar camera"  value="<?php echo $fir; ?>" >
        <input type="text" name="lan" placeholder="Clasa camera" value="<?php echo $lan; ?>" >
        <input type="text" name="biy" placeholder="Capacitate" value="<?php echo $by; ?>"    >
        <input type="text" name="addr" placeholder="Pret" value="<?php echo $addr; ?>" >
        <input type="text" name="desc"placeholder="Descriere" value="<?php echo $desc; ?>">
